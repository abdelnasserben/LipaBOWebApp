...
class MockDataService
{
    ...
    public static function customers(array $filters = []): array
    {
        ...
        if (! empty($filters['search'])) {
            ...
            $rows = array_filter($rows, fn ($r) => str_contains(strtolower($r['fullName']), $s) ||
    ...
    public static function merchants(array $filters = []): array
    {
        ...
        if (! empty($filters['search'])) {
            $s = strtolower($filters['search']);
            $rows = array_filter($rows, fn ($r) => str_contains(strtolower($r['businessName']), $s) ||
                str_contains(strtolower($r['externalRef']), $s)
            );
        }
    ...
    public static function approvals(array $filters = []): array
    {
        $rows = [
            ...
            ['id' => 'ap04', 'type' => 'FEE_RULE_CHANGE', 'status' => 'PENDING_APPROVAL', 'requestedBy' => '11111111-0000-0000-0000-000000000001', 'targetEntityType' => 'FEE_RULE', 'targetEntityId' => 'fr01', 'payload' => json_encode(['action' => 'CREATE', 'name' => 'Standard Cash-In Fee', 'transactionType' => 'CASH_IN', 'calculationType' => 'PERCENTAGE', 'percentage' => 1, 'feeBearer' => 'SENDER']), 'expiresAt' => '2026-05-09T11:00:00Z', 'createdAt' => '2026-05-06T11:00:00Z'],
    ...
    {
        $rows = [
            ['id' => 'fr01', 'name' => 'Standard Cash-In', 'description' => '1% on all CASH_IN', 'transactionType' => 'CASH_IN', 'actorType' => null, 'actorId' => null, 'cardType' => null, 'merchantCategory' => null, 'minAmount' => null, 'maxAmount' => null, 'calculationType' => 'PERCENTAGE', 'flatAmount' => null, 'percentage' => 1, 'minFeeAmount' => 100, 'maxFeeAmount' => 5000, 'feeBearer' => 'SENDER', 'priority' => 10, 'validFrom' => '2025-01-01T00:00:00Z', 'validTo' => null, 'active' => true, 'version' => 1, 'previousVersionId' => null, 'createdAt' => '2025-01-01T00:00:00Z'],
            ['id' => 'fr02', 'name' => 'Standard Cash-Out', 'description' => '1.5% on CASH_OUT', 'transactionType' => 'CASH_OUT', 'actorType' => null, 'actorId' => null, 'cardType' => null, 'merchantCategory' => null, 'minAmount' => null, 'maxAmount' => null, 'calculationType' => 'PERCENTAGE', 'flatAmount' => null, 'percentage' => 1.5, 'minFeeAmount' => 200, 'maxFeeAmount' => 10000, 'feeBearer' => 'SENDER', 'priority' => 10, 'validFrom' => '2025-01-01T00:00:00Z', 'validTo' => null, 'active' => true, 'version' => 2, 'previousVersionId' => null, 'createdAt' => '2025-01-01T00:00:00Z'],
    ...
    {
        $rows = [
            ['id' => 'cr01', 'name' => 'Cash-In Agent Commission', 'transactionType' => 'CASH_IN', 'agentId' => null, 'calculationType' => 'ON_FEE_AMOUNT', 'flatAmount' => null, 'percentage' => 50, 'settlementMode' => 'BATCH_DAILY', 'currency' => 'KMF', 'priority' => 10, 'validFrom' => '2025-01-01T00:00:00Z', 'validTo' => null, 'active' => true, 'version' => 1, 'previousVersionId' => null, 'createdBy' => '11111111-0000-0000-0000-000000000001', 'createdAt' => '2025-01-01T00:00:00Z', 'modifiedAt' => null],
            ['id' => 'cr02', 'name' => 'Cash-Out Agent Commission', 'transactionType' => 'CASH_OUT', 'agentId' => null, 'calculationType' => 'ON_FEE_AMOUNT', 'flatAmount' => null, 'percentage' => 50, 'settlementMode' => 'BATCH_DAILY', 'currency' => 'KMF', 'priority' => 10, 'validFrom' => '2025-01-01T00:00:00Z', 'validTo' => null, 'active' => true, 'version' => 1, 'previousVersionId' => null, 'createdBy' => '11111111-0000-0000-0000-000000000001', 'createdAt' => '2025-01-01T00:00:00Z', 'modifiedAt' => null],
            ...
            ['id' => 'cr04', 'name' => 'Premium Agent Cash-In', 'transactionType' => 'CASH_IN', 'agentId' => 'ag05', 'calculationType' => 'ON_TRANSACTION_AMOUNT', 'flatAmount' => null, 'percentage' => 0.5, 'settlementMode' => 'BATCH_DAILY', 'currency' => 'KMF', 'priority' => 1, 'validFrom' => '2025-03-01T00:00:00Z', 'validTo' => null, 'active' => true, 'version' => 1, 'previousVersionId' => null, 'createdBy' => '11111111-0000-0000-0000-000000000001', 'createdAt' => '2025-03-01T00:00:00Z', 'modifiedAt' => '2025-03-15T00:00:00Z'],
        ];
    ...
    public static function notifications(): array
    {
        return [
            [
                ...
                'body' => 'Un paiement de 15 250 KMF (réf. 21000123456) vient d\'être mis en file.',
                'data' => json_encode(['billPaymentId' => 'bp01', 'type' => 'SERVICE_PAYMENT_QUEUED']),
                'status' => 'UNREAD',
                'createdAt' => '2026-05-21T06:05:05Z',
                'readAt' => null,
            ],
            [
                ...
                'category' => 'BILL_PAYMENT',
                'title' => 'Nouveau paiement à traiter',
                'body' => 'Un paiement de 251 500 KMF (réf. 21000998877) vient d\'être mis en file.',
                'data' => json_encode(['billPaymentId' => 'bp02', 'type' => 'SERVICE_PAYMENT_QUEUED']),
                'status' => 'UNREAD',
                'createdAt' => '2026-05-21T06:22:05Z',
                'readAt' => null,
            ],
            [
                ...
                'category' => 'BILL_PAYMENT',
                'title' => 'Nouveau paiement à traiter',
                'body' => 'Un paiement de 45 550 KMF (réf. 21000776655) vient d\'être mis en file.',
                'data' => json_encode(['billPaymentId' => 'bp07', 'type' => 'SERVICE_PAYMENT_QUEUED']),
                'status' => 'READ',
    ...
    public static function wallets(array $filters = []): array
    {
        ...
        if (! empty($filters['search'])) {
            $s = strtolower($filters['search']);
            $rows = array_filter($rows, fn ($r) => str_contains(strtolower($r['id']), $s) ||
