...
new class extends Component
{
    ...
    public function resetAuthPin(): void
    {
        ...
        $updated = $this->api()->resetCustomerAuthPin($id);

        $this->selected = $updated !== []
            ? array_replace($this->selected, $updated)
            : $this->api()->customer($id);
        $this->showPinResetConfirm = false;
        $this->notify('Customer PIN reset. The customer must set a new PIN at next login.', 'success');
    }
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="table-row-link" wire:click="selectRow('{{ $row['id'] }}')">
                        ...
                        <td><x-mono>{{ $this->phoneCountryCodeLabel($row['phoneCountryCode'] ?? '') }} {{ $row['phoneNumber'] }}</x-mono></td>
        ...
        <div class="drawer-body">
            ...
            <div class="drawer-section">
                ...
                <div class="drawer-field">
                    ...
                    <span class="drawer-field-value">{{ $this->phoneCountryCodeLabel($selected['phoneCountryCode'] ?? '') }} {{ $selected['phoneNumber'] }}</span>
                </div>
            </div>
            ...
            <div class="alert alert-warning">
                <div>
                    ...
                    <br />This forces the customer to set a new PIN at next login.
                    <div class="mt-2.5 flex gap-2">
