...
<head>
    ...
    <title>{{ $title ?? 'Backoffice' }} — KomoPay</title>
...
<div class="app-shell">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-logo">
            ...
            <div>
                <div class="sidebar-logo-text">KomoPay</div>
